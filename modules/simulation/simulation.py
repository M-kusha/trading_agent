...
class ShadowSimulator(Module):
    ...
    Full audit trail of each planned trade/decision.
    Evolvable: horizon and simulation mode can mutate/crossover.
    """
...
class RoleCoach(Module):
    ...
    Logs every step’s rationale. Evolvable max_trades & penalty.
    """
    def __init__(
        self,
        max_trades: int = 2,
