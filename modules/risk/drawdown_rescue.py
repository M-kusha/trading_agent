...
class DrawdownRescueConfig:
    ...
    dd_limit: float = 0.085
    warning_dd: float = 0.025
    info_dd: float = 0.015
    recovery_threshold: float = 0.05


    velocity_window: int = 10
    lookback_balance: int = 120


    rapid_velocity: float = 0.02
    moderate_velocity: float = 0.01
    recovery_velocity: float = -0.01
    ...
    risk_smoothing: float = 0.30
    rescue_decay_per_min: float = 0.001
