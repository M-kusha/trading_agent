...
#         try:
#             # Use canonical publishers first; fall back to kernel mirrors and local namespace.
#             committee_sources = ["EnhancedVotingCommitteeCoordinator", "EnhancedVotingCommittee", "VotingKernel", "StrategyArbiter"]
#             consensus_sources = ["ConsensusDetector", "VotingKernel", "StrategyArbiter"]
#             collusion_sources = ["CollusionAuditor", "VotingKernel", "StrategyArbiter"]
#             horizon_sources = ["TimeHorizonAligner", "VotingKernel", "StrategyArbiter"]
#             market_sources = ["MarketDataProvider", "UnifiedMarketModule", "StrategyArbiter"]
#             kernel_sources = ["VotingKernel", "StrategyArbiter"]

#             # Use proposal_vectors (numeric) when available, fall back to member_proposals (rich dicts)
#             proposal_vectors = (
#                 self._bus_get_first("committee_proposal_vectors", committee_sources)
#                 or self._bus_get_first("proposal_vectors", committee_sources)
#                 or []
#             )
#             member_proposals = (
#                 self._bus_get_first("committee_votes", committee_sources)
#                 or self._bus_get_first("votes", committee_sources)
#                 or self._bus_get_first("expert_votes", committee_sources)
#                 or self._bus_get_first("member_proposals", committee_sources)
#                 or []
#             )
#             member_confidences = (
#                 self._bus_get_first("committee_member_confidences", committee_sources)
#                 or self._bus_get_first("member_confidences_ordered", committee_sources)
#                 or self._bus_get_first("member_confidences", committee_sources)
#                 or []
#             )

#             return {
#                 "market_context": self._bus_get_first("market_context", market_sources, default={}) or {},
#                 "recent_trades": self._bus_get_first("recent_trades", market_sources, default=[]) or [],
#                 "current_positions": self._bus_get_first("current_positions", market_sources, default=[]) or [],
...
#                 "consensus_score": self._bus_get_first("consensus_score", consensus_sources, default=0.5) or 0.5,
#                 "collusion_score": self._bus_get_first("collusion_score", collusion_sources, default=0.0) or 0.0,
#                 "horizon_alignment": self._bus_get_first("horizon_alignment_meta", horizon_sources, default={})
#                 or self._bus_get_first("horizon_alignment", horizon_sources, default={})
#                 or {},
#                 "volatility_data": self._bus_get_first("volatility_data", market_sources, default={}) or {},
#                 "market_regime": self._bus_get_first("market_regime", market_sources, default="unknown") or "unknown",
#                 "session_data": self._bus_get_first("session_data", market_sources, default={}) or {},
#                 "instruments": self._bus_get_first("instruments", market_sources, default=list(getattr(self, "instruments", [])))
#                 or list(getattr(self, "instruments", [])),
#                 "decision_id": self._bus_get_first("kernel_decision_id", kernel_sources)
#                 or self._bus_get_first("decision_id", kernel_sources),
#                 "tick_ts": self._bus_get_first("kernel_tick_ts", kernel_sources)
#                 or self._bus_get_first("tick_ts", kernel_sources),
#             }
#         except Exception as e:
...
#     def _evaluate_gate(self, action: np.ndarray, consensus: float, collusion: float) -> Tuple[bool, float, Dict[str, Any]]:
#         """
...
#             # Apply post-gate risk throttles for uncertainty/collusion
#             risk_penalty = 1.0
#             fragility = 0.0
#             collusion_score = 0.0
#             risk_overridden = False
#             try:
#                 fragility = float(self.smart_bus.get("fragility", "StrategyArbiter")
#                                   or self.smart_bus.get("sampling_fragility", "StrategyArbiter")
#                                   or 0.0)
#                 collusion_score = float(self.smart_bus.get("collusion_score", "StrategyArbiter") or 0.0)
#                 # Hard stop if uncertainty or collusion is extreme
#                 if fragility >= 0.9 or collusion_score >= 0.9:
#                     passed = False
#                     action_label = "abstain"
#                     strength = 0.0
#                     confidence = 0.0
...
#                 else:
#                     risk_penalty = 1.0 - (0.5 * fragility + 0.4 * collusion_score)
#                     risk_penalty = float(np.clip(risk_penalty, 0.25, 1.0))
