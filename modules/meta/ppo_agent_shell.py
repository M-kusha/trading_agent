...
class PPOAgentShell(
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self._obs_frame_buffer: Dict[str, List[np.ndarray]] = {}
    ...
    async def process(self, **inputs: Any) -> Dict[str, Any]:
        ...
        try:
            ...
            if in_warmup:
                ...
                elif self._session_cycle_count % 5 == 0:
                    self.logger.info(
    ...
    def _build_observations_for_instruments(self) -> Dict[str, np.ndarray]:
        ...
        base_obs_size = self._cfg.core_config.obs_size
