...
class PPOAutonomyState:
    ...
    ppo_consistency: float = 0.0
    ppo_confidence_accuracy: float = 0.0
...
class PPOAutonomyTracker:
    ...
    def _calculate_target_autonomy(self) -> float:
        ...
        pf_raw = max(0.0, self.state.ppo_profit_factor - 1.0)
        pf = float(np.tanh(pf_raw))
...
class ArbiterLogic:
    ...
    def __init__(
        ...
        self._autonomy_save_interval = 10
    ...
    def make_multi_instrument_decision(
        ...
        positions_by_instrument: Optional[Dict[str, Any]] = None,
        defer_stats_recording: bool = False,
    ) -> ArbiterMultiDecision:
