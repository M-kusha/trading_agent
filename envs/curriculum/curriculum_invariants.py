...
class RateLimitedInvariantLogger:
    ...
    DEFAULT_RATE_LIMITS: ClassVar[Dict[InvariantSeverity, float]] = {
        InvariantSeverity.INFO: 300.0,
        InvariantSeverity.WARNING: 60.0,
        InvariantSeverity.ERROR: 10.0,
        InvariantSeverity.CRITICAL: 0.0,
    }
    ...
    def reset_epoch(self, epoch: int, stage_name: str = "") -> None:
        ...
        stale_keys = [
            ...
            if k[2] != stage_name and t < cutoff_time
        ]
        for k in stale_keys:
            del self._last_log_time[k]
...
class AntiGamingChecker:
    ...
    MIN_MEANINGFUL_RISK_EXPOSURE = 0.001
    MIN_TIME_IN_TRADE = 3
    MAX_WINNER_CUT_RATIO = 0.3
...
DEFAULT_METRIC_BOUNDS = [
    ...
    MetricBounds("profit_factor", 0.0, 100.0),
    ...
    MetricBounds("policy_entropy", -1.0, 10.0),
...
class CurriculumInvariantChecker:
    ...
    def __init__(self, verbose: bool = False):
        ...
        self._stage_history: List[Tuple[str, int]] = []
